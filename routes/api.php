...
Route::post('/bookmarks/stories/{storyId}', "BookmarkController@add");
...
Route::post('/stories/{id}/reactions/like', "StoryController@like");

Route::post('/stories/{id}/reactions/dislike', "StoryController@dislike");
