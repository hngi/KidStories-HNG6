...
return [
    ...
    */
    ...
    // For testing and staging only
    'cloudName'  => env('CLOUDINARY_CLOUD_NAME', 'betterminds'),
    'baseUrl'    => env('CLOUDINARY_BASE_URL', 'http://res.cloudinary.com/betterminds'),
    'secureUrl'  => env('CLOUDINARY_SECURE_URL', 'https://res.cloudinary.com/betterminds'),
    'apiBaseUrl' => env('CLOUDINARY_API_BASE_URL', 'https://api.cloudinary.com/v1_1/betterminds'),
    'apiKey'     => env('CLOUDINARY_API_KEY', '314428534675396'),
    'apiSecret'  => env('CLOUDINARY_API_SECRET', 'KxZklqBJqfe4jIJ_pj26oW8ihqE'),
    // Ends here
