...
class StoriesController extends Controller
{
    ...
    public function update(StoryRequest $request,Tag $tag){

        $update = Story::findOrFail(auth()->id());
        ...
        $update->tags()->attach($tag->getTagsIds($request->tags));

    DB::commit(); //dd('Inside the store before redirect');
    return redirect()->route('story.show', ['story' => $update->slug]);
