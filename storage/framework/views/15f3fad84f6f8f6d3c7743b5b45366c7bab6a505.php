...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container mt-50">
            <section id="profile">
                <div id="image">
                    <img src="<?php echo e(! is_null($user->image_url) ? $user->image_url : '/images/profile/imgIcon.png'); ?>" alt="Profile Pic" class="profilePic"> 
                ...
                <div class="nameContent">   
                    <h3 class="profileName"> <?php echo e($user->fullname); ?> </h3>
                    <?php if($user->location): ?>
                    <p class="location"> <?php echo e($user->location); ?> </p>
                    <?php endif; ?>
                <div>
            </section>
        </div>
        ...
        <div class="container form-container">  
            ...
            <form action="<?php echo e(route('profile.update')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <input class="form-control" type="text" name="first_name" value="<?php echo e($user->first_name); ?>" id="inputFirstName" placeholder="Enter First Name" />
                ...
                <div>
                    ...
                    <input class="form-control" type="text" name="last_name" value="<?php echo e($user->last_name); ?>" id="inputLastName" placeholder="Enter Last Name" />
                ...
                <div>
                    ...
                    <input class="form-control" type="email" name="email" value="<?php echo e($user->email); ?>" id="inputEmail" placeholder="Enter Email" />
                ...
                <div>
                    ...
                    <input class="form-control" type="tel" name="phone" value="<?php echo e($user->phone); ?>" id="inputPhoneNumber" placeholder="Enter Phone Number" />
                </div>

                <div>
                    <label for="inputLocation"> Location </label>
                    <input class="form-control" type="text" name="location" value="<?php echo e($user->location); ?>" id="inputLocation" placeholder="Enter Location" />
                </div>

                <div>
                    <label for="inputPostal"> Postal Code </label>
                    <input class="form-control" type="text" name="postal_code" value="<?php echo e($user->postal_code); ?>" id="inputPostal" placeholder="Enter Phone Code" />
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kelvin/HNG-5/CODE-TESTS/kidstories-main-repo/resources/views/profile.blade.php ENDPATH**/ ?>