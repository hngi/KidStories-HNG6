...
<div class="auto-container adjust-padding">
    <?php if($stories->first()): ?>
    <div class="mb-5 catheader">
        <h3><?php echo e($stories->first()->category->name); ?> Listing</h3>
    </div>
    <?php endif; ?>
            ...
            <div class="d-flex flex-row col-md-12  ">
                <div class="col-md-12" id="category-drop">
                    ...
                    <div class="searchContainer">
                        ...
                        <form action="<?php echo e(route('categories.stories', $currentCategory)); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kelvin/HNG-5/CODE-TESTS/kidstories-main-repo/resources/views/categories_stories.blade.php ENDPATH**/ ?>