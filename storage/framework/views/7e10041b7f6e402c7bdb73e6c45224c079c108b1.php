                ...
                <div class="d-flex flex-row flex-wrap">
                    ...
                    <div class="card col-lg-12 p-0 story-card mb-4 premium-badge-holder">
                                ...
                                <div class="card-body story-card-body">
                                    <h5 class="card-title"><a href="<?php echo e(route('story.show',$story->slug)); ?>"><?php echo e($story->title); ?></a></h5>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <p style="font-size:24px; margin-top: 20px; font-weight: 200; text-align: center;">
                            ...
                            <a href="<?php echo e(route('story.create')); ?>" class="btn btn-block" style="margin-top: 10px;">
                                Create New Story
                            </a>
                        </p>
                    <?php endif; ?>
                                ...
                                <li class="list-group-item">
                                    ...
                                    <select class="form-control form-control-sm" name="category" style="margin-bottom: 8px;">
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->id); ?>" <?php echo e(!is_null(request()->query('category')) && request()->query('category') == $category->id ? 'selected' : ''); ?>><?php echo e($category->name); ?></option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kelvin/HNG-5/CODE-TESTS/kidstories-main-repo/resources/views/mystories.blade.php ENDPATH**/ ?>