...
<div class="sp-container">
    ...
    <section id="sp-story">
        <div class="sp-story">
            ...
            <h1 class="sp-story-title"><?php echo e($story->title); ?></h1>
            ...
            <img class="sp-story-imgx" src="<?php echo e($story->image_url); ?>">
            <p class="sp-story-cont"><?php echo e($story->body); ?></p>
            <div class="sp-story-footer">
                ...
                <div class="sp-interactions">
                    <ul class="sp-int-btns">
                        <li class="sp-int-btn"><small class="mr-3" id="likes-count-<?php echo e($story->id); ?>"><?php echo e($story->likes_count); ?></small><i class="fa fa-thumbs-up mr-2 liked fav-icon" id="fav-like" onclick="react(event);" data-story-id="<?php echo e($story->id); ?>"></i></li>
                        <li class="sp-int-btn"><small id="dislikes-count-<?php echo e($story->id); ?>"><?php echo e($story->dislikes_count); ?></small><i class="fa fa-thumbs-down mr-2 fav-icon" id="fav-dislike" onclick="react(event);" data-story-id="<?php echo e($story->id); ?>"></i></li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kelvin/HNG-5/CODE-TESTS/kidstories-main-repo/resources/views/story.blade.php ENDPATH**/ ?>