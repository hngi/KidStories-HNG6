...
<div class="auto-container adjust-padding">
    <div class="mb-3">
        <h3><?php echo e($category->name); ?> Category Listing</h3>
    </div>
    <div class="col-md-12 d-flex flex-row p-0 ">
        <div class="col-md-9 p-0">
            <div class="d-flex flex-column col-md-12  p-0">
                <?php if(count($category->stories) > 0): ?>

                <div class="d-flex flex-row flex-wrap justify-content-betwee">
                    <?php $__currentLoopData = $category->stories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-12" id="category-drop">
                    ...
                    <div class="card" style="width: 15rem;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><a href="/categories/<?php echo e($category->id); ?>/stories/sort/age" style="color:inherit;">Age </a> <i class="fas fa-graduation-cap icon-right"></i></li>
                            
                            <li class="list-group-item"><a href="/categories/<?php echo e($category->id); ?>/stories/sort/recent" style="color:inherit;">Most Recent </a><i class="fas fa-tint icon-right"></i></li>
                        </ul>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kelvin/HNG-5/CODE-TESTS/kidstories-main-repo/resources/views/storieslisting.blade.php ENDPATH**/ ?>