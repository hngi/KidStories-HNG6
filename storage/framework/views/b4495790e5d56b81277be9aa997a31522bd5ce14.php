<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('admin.stories.partials.header', ['title' => __('Add Story')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>   
            ...
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="<?php echo e(route('admin.stories.store')); ?>"
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group <?php echo e($errors->has('body') ? ' has-danger' : ''); ?>">
                                    ...
                                    <textarea style="height:200px" type="text" class="form-control form-control-alternative" name="body" required><?php echo e(old('body')); ?></textarea>
                                ...
                                <div class="form-group <?php echo e($errors->has('age') ? ' has-danger' : ''); ?>">
                                    ...
                                    <input  type="text" name="age"
                                        class="form-control form-control-alternative"  required 
                                        value="<?php echo e(old('age')); ?>" placeholder="Example: 1-3">
                                ...
                                <div class="form-group <?php echo e($errors->has('is_premium') ? ' has-danger' : ''); ?>">
                                        ...
                                        <label>                                   
                                            <input type="radio" name="is_premium" value="1" <?php echo e(old('is_premium')==1?'checked':''); ?>> Premium
                                        </label> <br>
                                        <label>
                                            <input type="radio" name="is_premium" value="0"
                                            <?php echo e(old('is_premium')==='0'?'checked':''); ?>> Regular<br>
                                        </label>   
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', ['title' => __('Manage Stories')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kelvin/HNG-5/CODE-TESTS/kidstories-main-repo/resources/views/admin/stories/create.blade.php ENDPATH**/ ?>