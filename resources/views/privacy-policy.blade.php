...
@endsection
@section('content')
<div class="d-flex p-2 privacy-policy">
    <div class="col-lg-8 mx-auto text-justify">
        <h1 class="text-center mx-auto">Privacy Policy</h1>
        <p><strong>Effective date:</strong> October 30, 2019.</p>
        <p>Kid Stories ("us", "we", or "our") operates the Kid Stories mobile application (hereinafter referred to as the "Service").</p>
        <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. The Privacy Policy  for Kid Stories has been created with the help of <a href="https://www.termsfeed.com/privacy-policy-generator/">Privacy Policy Generator</a>.</p>
            ...
            <ul>
                <li>
                    <p><strong>Service</strong></p>
                            <p>Service is the Kid Stories mobile application operated by Kid Stories</p>
                        </li>
                <li>
        ...
        <div>
            ...
            <p>Kid Stories uses the collected data for various purposes:</p>    
            <ul>
        ...
        <div>
            ...
            <p>Kid Stories will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
        </div>
        ...
        <div>
            ...
            <p>Kid Stories may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of Kid Stories</li>
        ...
        <div>
            ...
            <ul>
                <li>By email: <a href="mailto:seyi@hng.tech">seyi@hng.tech</a></li>
            </ul>
        </div>  
    </div>
</div>
