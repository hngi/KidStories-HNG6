                ...
                <div class="col-md-3">
                    <div class="card favorite_story_card mt-4">
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            <div class="reactions">
                                <i class="fa fa-thumbs-up mr-2 liked fav-icon" id="fav-like" onclick="react(event);" data-story-id="{{ $bookmark->id }}"></i><small class="mr-3" id="likes-count-{{ $bookmark->id }}">{{$bookmark->likes_count}}</small>
                                <i class="fa fa-thumbs-down mr-2 fav-icon" id="fav-dislike" onclick="react(event);" data-story-id="{{ $bookmark->id }}"></i><small id="dislikes-count-{{ $bookmark->id }}">{{$bookmark->dislikes_count}}</small>
                            </div>
                            <div class="bookmark">
